...
if __name__ == '__main__':  # Точка входа при запуске этого скрипта
    ...
    # data = store.getdata(dataname=symbol, timeframe=TimeFrame.Minutes, compression=5, fromdate=datetime(2023, 1, 16, 10, 5), todate=datetime(2023, 1, 16, 10, 55), LiveBars=False)
    ...
    # data = store.getdata(dataname=symbol, timeframe=TimeFrame.Minutes, compression=1, fromdate=datetime(2023, 1, 16), LiveBars=True)
